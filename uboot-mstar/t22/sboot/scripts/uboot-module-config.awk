...
$2 == "ENABLE_DISABLE_MBOOTBAK" {print "#define ENABLE_MODULE_DISABLE_MBOOTBAK " $3}
$2 == "ENABLE_MMC" {print "#define ENABLE_MODULE_MMC " $3}
$2 == "ENABLE_MSTAR_UFS" {print "#define ENABLE_MODULE_MSTAR_UFS " $3}
...
$2 == "ENABLE_ENV_IN_UFS" {print "#define ENABLE_MODULE_ENV_IN_UFS " $3}
...
$2 == "ENABLE_INFO_IN_UFS_ENV" {print "#define ENABLE_MODULE_INFO_IN_UFS_ENV " $3}
