...
#endif
#if defined(CONFIG_CMD_UFS)
	specs[ENUM_UFS].max_dev = 0;
	specs[ENUM_UFS].enum_started = 0;
	specs[ENUM_UFS].enum_ended = 0;
	specs[ENUM_UFS].type = DEV_TYP_STOR | DT_STOR_UFS;
	specs[ENUM_UFS].name = "ufs";
#endif
