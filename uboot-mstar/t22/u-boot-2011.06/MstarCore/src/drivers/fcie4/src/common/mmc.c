...
#endif	
#if TEST_18V
//----- voltage switch start here -----------
printf("check 1.8v\n");
	if (sd_check_18V(mmc)==0)
	{
       	printf("support 1.8V\n");
		sd_go_18V(mmc);
		printf("ok\n");
		mmc->clock = 0;
		mmc_set_ios(mmc);		//stop clock
		sd_gpio_low();
