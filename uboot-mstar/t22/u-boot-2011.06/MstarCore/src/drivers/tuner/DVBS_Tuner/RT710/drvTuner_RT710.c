...
01/15/2014	   Ryan				v2.4		modify  setting Frequency from 1650~2000MHz
...
#if(FRONTEND_TUNER_TYPE==TUNER_RT710)
...
RT710_Err_Type RT710_PLL(MS_U8 u8TunerIndex, unsigned long PLL_Freq);
    ...
    UINT8 RT710_Reg_Arry_Init[RT710_Reg_Num] ={0x40, 0x1C, 0xA0, 0x90, 0x41, 0x50, 0xED, 0x25, 0x47, 0x58, 0x38, 0x60, 0x38, 0xE7, 0x90, 0x35};
#else
    //-10~-30dBm ; LT:lna center ; LT:HPF on  ; LT Current Low
    UINT8 RT710_Reg_Arry_Init[RT710_Reg_Num] ={0x40, 0x1D, 0xA0, 0x10, 0x41, 0x50, 0xED, 0x25, 0x07, 0x58, 0x38, 0x64, 0x38, 0xE7, 0x90, 0x35};
#endif

UINT8 RT720_Reg_Arry_Init[RT710_Reg_Num] ={0x00, 0x1C, 0x80, 0x10, 0x41, 0x48, 0xDA, 0x4B, 0x07, 0x58, 0x38, 0x40, 0x37, 0xE7, 0x4C, 0x59};
...
RT710_Err_Type RT710_Setting(MS_U8 u8TunerIndex)
{
    ...
    if(pstRT710->Chip_type_Is_RT710 == TRUE)
    {
        ...
        else
        {
            ...
            {
                pstRT710->Reg_Arry[10] = ((pstRT710->Reg_Arry[10] & 0xF0) | 0x07); //AGC VTH:1.14V
    ...
    {
        //Scan_Type
        //if(pstRT710->Info_Msg.RT710_Scan_Mode != AUTO_SCAN
        //{
            pstRT710->Reg_Arry[11] &= 0xFC;
        //}
        //else
        //{
            pstRT710->Reg_Arry[11] |= 0x03;
        //}
    ...
    {
        case ROLL_OFF_0_15:
            pstRT710->satellite_bw = (UINT32)(pstRT710->Info_Msg.SymbolRate_KHz * 11.5);
            break;
        case ROLL_OFF_0_20:
            pstRT710->satellite_bw = (UINT32)(pstRT710->Info_Msg.SymbolRate_KHz * 12.0);
            break;
        case ROLL_OFF_0_25:
            pstRT710->satellite_bw = (UINT32)(pstRT710->Info_Msg.SymbolRate_KHz * 12.5);
            break;
        case ROLL_OFF_0_30:
            pstRT710->satellite_bw = (UINT32)(pstRT710->Info_Msg.SymbolRate_KHz * 13.0);
            break;
        case ROLL_OFF_0_35:
            pstRT710->satellite_bw = (UINT32)(pstRT710->Info_Msg.SymbolRate_KHz * 13.5);
            break;
        case ROLL_OFF_0_40:
            pstRT710->satellite_bw = (UINT32)(pstRT710->Info_Msg.SymbolRate_KHz * 14.0);
            break;
    }
...
{
    return MDrv_Tuner_RT710_Initial(0, NULL);
}

MS_BOOL MDrv_Tuner_RT710_SetFreq_S2(MS_U8 u8TunerIndex, MS_U32 dwFreq, MS_U32 u32SymbolRate_kHz)
{
    printf(" MDrv_Tuner_SetFreq Freq %d, u32SymbolRate_kHz %d \n", dwFreq,u32SymbolRate_kHz);
    RT710_Handle* pstRT710= NULL;
...
MS_BOOL MDrv_Tuner_SetFreq(MS_U32 dwFreq, MS_U32 u32SymbolRate_kHz)
{
    return MDrv_Tuner_RT710_SetFreq_S2(0, dwFreq, u32SymbolRate_kHz);
}
...
MS_BOOL MDrv_Tuner_RT710_CheckExist(MS_U8 u8TunerIndex, MS_U32* pu32channel_cnt)
{
    ...
    {
        TUNER_ERR(("[RT710] Read chip ID fail \n"));
    }
    regData = RT710_Read_Len.Data[0];
    TUNER_ERR(("[RT710] read id =0x%x\n",regData));
