...
#if defined(CONFIG_URANUS4) || defined(CONFIG_KRONUS) || defined(CONFIG_KAISERIN) || defined(CONFIG_KENYA) || defined(CONFIG_KERES) || defined(CONFIG_KIRIN) || defined(CONFIG_KRITI) || defined(CONFIG_K5AP) || defined(CONFIG_KRATOS) ||defined(CONFIG_KRIS) ||defined(CONFIG_KIWI)||defined(CONFIG_K1C)
#define UART_BAUD_RATE	            115200//38400 //9600 //19200 //38400 //57600 //115200 =>too frequent Rx INT
// Clock source
#define UART_CLK_FREQ               123000000//43200000 //123000000//14318180
#endif
