 ...
 * @is_mlc: Is the NAND type MLC? 0: SLC, 1: MLC
...
//typedef struct _PAIRED_PAGE_MAP {
    //unsigned short u16_LSB;
    //unsigned short u16_MSB;
...
int ubi_update_partial_data(struct ubi_device *ubi, struct ubi_volume *vol, void *buf, off_t offset, size_t size);
...
ubi_zalloc_vid_hdr(const struct ubi_device *ubi, gfp_t gfp_flags)
{
	...
	vid_hdr = (void *)kzalloc(ubi->vid_hdr_alsize, gfp_flags);
	if (!vid_hdr)
		return NULL;
