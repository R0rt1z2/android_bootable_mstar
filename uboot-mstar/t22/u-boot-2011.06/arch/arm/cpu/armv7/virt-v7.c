...
#ifdef CONFIG_AMP_TRUSTZONE_ENABLE //hardcode patch for monaco STR Fixme late
	writel(0xc000ffff, 0x16001080); //set group
	writel(0xc000ffff, 0x16001100); //set enable
	writel(0x20000000, 0x16001180); //set clear irq 29
	writel(0xF0, 0x16002004); 
#endif
