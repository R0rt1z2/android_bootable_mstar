...
#define CPUID_ARM_GENTIMER_	MASK (0xF << CPUID_ARM_GENTIMER_SHIFT)
...
#define CCSIDR_ASSOCIATIVITY_MASK (0x		3FF << 3)
 ...
 *      */
#define CP15ISBasm volatile ("mcr	     p15, 0, %0, c7, c5, 4" : : "r" (0))
#define CP15DSBasm volatile (	"mcr     p15, 0, %0, c7, c10, 4" : : "r" (0))
#define CP15DMBasm volatile ("mcr     p15, 0, %0, c7, c10, 5" : : "r" (0))
