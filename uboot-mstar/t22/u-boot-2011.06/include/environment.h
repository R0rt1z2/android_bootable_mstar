...
extern struct hsearch_data env_htab_rescue;
#endif
...
#define BRICK_TERMINATOR_SWITCH_STR "BRICK_TERMINATOR_SWITCH"
#endif
...
#include <mmc.h>
typedef int (*write_env_cb)(struct mmc *, unsigned long, unsigned long, const void *);
typedef int (*read_env_cb)(struct mmc *, unsigned long, unsigned long, const void *);
void RegisterCBReadEnv(read_env_cb cb);
void RegisterCBWriteEnv(read_env_cb cb);
#endif
