...
#if 1 //MStar
int lzo1x_decompress_safe_adapter(const unsigned char *in, size_t in_len,
			  unsigned char *out, size_t *out_len)
{
	return lzo_decompress_ubifs((unsigned char *)in, out, in_len, out_len);
}
#endif
...
static struct ubifs_compressor lzo_compr = {
	...
	.capi_name = "lzo",
#if 1 //MStar
	.decompress = lzo1x_decompress_safe_adapter,
#else
